// ================================================================================
// ARCHIVO: CMS.Entities/Operational/Vendor.cs
...
{
    /// <summary>
    /// Maestro de proveedores. Tabla: {schema}.vendor.
    /// </summary>
    [Table("vendor")]
    public class Vendor
    {
        ...
        [MaxLength(20)]
        [Column("vendor_type")]
        public string? VendorType { get; set; } = "Both";

        /// <summary>
        /// ID del comprador asignado.
        /// FK lógica a cms.admin.user.id_user (cross-DB).
        /// </summary>
        ...
        /// FK real a {schema}.vendor.id_vendor.
        /// </summary>
        [Column("id_parent_vendor")]
        public int? IdParentVendor { get; set; }
        ...
        [ForeignKey(nameof(IdParentVendor))]
